...
void main() {
    ...
    // Pattern 27
    // float strength = length(vUv-0.5); //op1
    // float strength = distance(vUv, vec2(0.5, 0.5)); //op2
    ...
    // Pattern 30
    // float strength = 0.015 / distance(vec2((vUv.x * 0.1) + 0.45, vUv.y * 0.5 + 0.25), vec2(0.5, 0.5));
    ...
    // Pattern 32
    // vec2 roatedUv = rotate(vUv, PI * 0.25, vec2(0.5, 0.5));
    // vec2 lightUvX = vec2((roatedUv.x * 0.1) + 0.45, roatedUv.y * 0.5 + 0.25);
    // float lightX = 0.015 / distance(lightUvX, vec2(0.5, 0.5));
    // vec2 lightUvY = vec2((roatedUv.y * 0.1) + 0.45, roatedUv.x * 0.5 + 0.25);
    // float lightY = 0.015 / distance(lightUvY, vec2(0.5, 0.5));
    ...
    // float strength = cnoise(vUv * 10.0);
      ...
      // Pattern 47
    // float strength = floor(cnoise(vUv * 10.0) + 1.0); //op1
    // // float strength = step(0.0, cnoise(vUv * 10.0)); //op2
    ...
    vec3 mixedColor = mix(blackColor, uvColor, strength * clampedElevation*10.0);
